    ...
    >
      <View className="flex-1 p-6 justify-center">
        ...
        <Text className="text-base text-black/60 dark:text-white/60 mb-8">
          Choose a unique username to get started. You'll be able to change it later, but you can
          only do so once every 7 days.
        </Text>

        <Text className="text-sm font-semibold mb-2 text-black dark:text-white">Username</Text>
        ...
        >
          {isChecking ? (
            ...
            <Text className="text-white text-base font-semibold">Check Availability</Text>
          )}
        </TouchableOpacity>
        ...
        {isAvailable === true && (
          <View className="bg-primary/10 p-3 rounded-lg mb-4 border border-primary flex-row items-center justify-center">
            <Ionicons
              ...
              style={{ marginRight: 8 }}
            />
            <Text className="text-primary font-semibold">Username available!</Text>
          </View>
        )}
        ...
        {isAvailable === false && (
          <View className="bg-black dark:bg-white p-3 rounded-lg mb-4 border border-black dark:border-white flex-row items-center justify-center">
            <Ionicons
              ...
              style={{ marginRight: 8 }}
            />
            <Text className="text-white dark:text-black font-semibold">Username already taken</Text>
          </View>
        )}
