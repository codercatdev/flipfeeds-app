...
export const getUserProfileTool = ai.defineTool(
    ...
    async (_input, { context }) => {
        ...
        console.log(
            '[getUserProfileTool] Profile fetched successfully, username:',
            profile.username
        );
        return profile;
    }
...
export const isUsernameAvailableTool = ai.defineTool(
    ...
    async (input) => {
        console.log(
            '[isUsernameAvailableTool] Checking availability for username:',
            input.username
        );
...
export const releaseUsernameTool = ai.defineTool(
    ...
    async (input, { context }) => {
        ...
        if (usernameDoc.exists) {
            ...
            if (data?.userId !== uid) {
                console.error(
                    '[releaseUsernameTool] Unauthorized: Username belongs to different user'
                );
